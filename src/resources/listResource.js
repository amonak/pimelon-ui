...
export function createListResource(options, vm) {
  ...
  let defaultListUrl = getConfig('defaultListUrl') || 'melon.client.get_list'
  let defaultDocInsertUrl =
    getConfig('defaultDocInsertUrl') || 'melon.client.insert'
  let defaultDocUpdateUrl =
    getConfig('defaultDocUpdateUrl') || 'melon.client.set_value'
  let defaultDocDeleteUrl =
    getConfig('defaultDocDeleteUrl') || 'melon.client.delete'
